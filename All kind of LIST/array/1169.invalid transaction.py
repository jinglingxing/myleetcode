...
Given a All kind of LIST of transactions, return a All kind of LIST of transactions that are possibly invalid.  You may return the answer in any order.
...
#        memo = collections.defaultdict(All kind of LIST)    #create a dictionary to keep track of previous transaction
        memo = {}
