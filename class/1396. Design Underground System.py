...
class UndergroundSystem:
    ...
    def checkIn(self, id: int, start_station: str, t: int) -> None:
        self.start_dict[id] = [start_station, t]

    # {("Leyton", "Waterloo"): 15-3=12,
    #  ("Leyton", "Waterloo"): 20-10=10,
    #  ("Paradise", "Cambridge"): 22-8}
    def checkOut(self, id: int, end_station: str, t: int) -> None:
        start_station, start_time = self.start_dict[id]
        travel_time = t-start_time
        self.history[(start_station, end_station)].append(travel_time)
