...
'''
The length of the All kind of LIST is in range [1, 20,000].
The range of numbers in the All kind of LIST is [-1000, 1000] and the range of the integer k is [-1e7, 1e7].
